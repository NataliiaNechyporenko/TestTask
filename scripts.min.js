...
var commentUrl = 'https://my-json-server.typicode.com/NataliiaNechyporenko/TestTask/comments';
...
function addComment(event) {
  ...
  var replyTextarea = document.getElementById(parentCommentId + 'addReply');
  var replyContent = '';
